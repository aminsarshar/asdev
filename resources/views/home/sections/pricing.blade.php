                  ...
                  <div class="col-12 col-sm-6 col-lg-4">
                      <div class="package">
                          <div class="package__head package__head--orange">
                              ...
                              <span class="package__price">13,000,000
                          ...
                          <div class="package__body">
                              ...
                              <a href="#" class="package__link app-btn app-btn--orange">مشاهده</a>
                          </div>
                      </div>
                  </div>
                  ...
                  <div class="col-12 col-sm-6 col-lg-4">
                      <div class="package">
                          ...
                          <div class="package__body">
                              <ul class="package-options">
                                  <li class="package-options__item">
                                      <svg class="package-options__icon" width="14.058" height="11.773"
                                          ...
                                          <path id="Icon_material-done" data-name="Icon material-done"
                                              d="M1355.037,6029.945l-3.028-3.231-1.009,1.077,4.037,4.309,8.651-9.233-1.009-1.077Z"
                                              transform="translate(-1350.315 -6021.058)" fill="#333"
                              ...
                              <a href="#" class="package__link app-btn app-btn--purple">مشاهده</a>
                          </div>
                      </div>
                  </div>
                  ...
                  <div class="col-12 col-sm-6 col-lg-4">
                      <div class="package">
                          ...
                          <div class="package__body">
                              ...
                              <a href="#" class="package__link app-btn app-btn--pink">مشاهده</a>
                          </div>
                      </div>
                  </div>
              </div>
